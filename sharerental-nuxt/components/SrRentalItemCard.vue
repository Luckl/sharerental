<template>
  <div class="p-2 bg-white rounded-lg hover:bg-gray-300 flex flex-col justify-between">
    <div class="p-2 h-full flex justify-center items-center">
        <NuxtImg class="rounded-lg" fit="inside" loading="lazy" sizes="224px" :src="determineImageUrl()"/>
    </div>
    <div>
      <div class="my-2">
